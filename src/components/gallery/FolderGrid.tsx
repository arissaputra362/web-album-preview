...
export default function FolderGrid({ folders, onSelectFolder }: FolderGridProps) {
  ...
  return (
    <div className="space-y-4 mb-10">
      <div className="flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-black/40">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {folders.map((folder) => (
          <button
            ...
            className="flex items-center justify-between p-4 bg-white rounded-[8px] border border-black/5 hover:border-black/15 shadow-2xs hover:shadow-xs transition-all text-left group cursor-pointer"
          >
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-black/40 font-mono">Buka Folder</p>
              </div>
            </div>
